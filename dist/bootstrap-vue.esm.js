...
var bDropdown = {
    ...
    computed: {
        ...
        menuClasses: function menuClasses() {
            return ['dropdown-menu', this.right ? 'dropdown-menu-right' : '', this.visible ? 'show' : '', this.customMenuClasses];
        }
    }
};
...
var bFormGroup$1 = {
    ...
    components: { bFormRow: bFormRow, bFormText: bFormText, bFormFeedback: bFormFeedback },
    render: function render(h) {
        var t = this;
        var $slots = t.$slots;
        ...
        var feedback = h('b-form-feedback', {
            directives: [{ name: 'show', value: t.feedback || $slots.feedback }],
            attrs: {
                id: t.feedbackId,
                role: 'alert',
                'aria-live': 'assertive',
        ...
        // Build layout
        var content = h('div', { ref: 'content', class: t.inputLayoutClasses }, [$slots.default, feedback, description]);
...
var bTabs = {
    ...
    render: function render(h) {
        ...
        // Nav 'button' wrapper
        var navs = h('ul', {
            class: ['nav', 'nav-' + t.navStyle, (_ref = {}, defineProperty$1(_ref, 'card-header-' + t.navStyle, this.card), defineProperty$1(_ref, 'small', t.small), _ref)],
